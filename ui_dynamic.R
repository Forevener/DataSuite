  ...
  tabItems(
    tabItem(
      ...
      box(
        ...
        ds.picker("si_include_vars", i18n$t("Выбор переменных для анализа"), TRUE, TRUE),
        verbatimTextOutput("data_info")
      ),
      fluidRow(
        hidden.box(
          class = NULL, id = "data_box", width = 12,
    ...
    tabItem(
      ...
      hidden.box(
        ...
        ds.picker("si_var_ctis", i18n$t("Независимая переменная")),
      ...
      hidden.box(
        ...
        ds.picker("si_var_cmis", i18n$t("Независимая переменная")),
    ...
    tabItem(
      "correlations",
      hidden.box(
        ds.picker("si_var1_corr", i18n$t("Строки матрицы"), TRUE),
        ds.picker("si_var2_corr", i18n$t("Столбцы матрицы"), TRUE),
    ...
    tabItem(
      "manova",
      hidden.box(
        ds.picker("si_vars_manova", i18n$t("Независимые переменные"), TRUE),
    ...
    tabItem(
      "regression",
      hidden.box(
        ds.picker("si_vars_regression", i18n$t("Независимые переменные"), TRUE),
